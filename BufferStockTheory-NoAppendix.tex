...
\begin{comment}
  \begin{align*}
    \overbrace{\mu_{\cRat}^{n} \bar{\cRat}_{t}}^{\bar{\cRat}_{t+n}}(\mu_{\cRat} - 1)\PGro^{n} & =(\mu_{\cv} - \PGro) \overbrace{\cv_{t}\mu_{\cv}^{n}}^{\cv_{t+n}}
\\                                                                                                 
    (\mu_{\cRat}\PGro/\mu_{\cv})^{n} \bar{\cRat}_{t}(\mu_{\cRat} - 1) & =(\mu_{\cv} - \PGro) \cv_{t}
  \end{align*}
    and a corresponding equation will hold in $t+1$:
  \begin{align*}
\\  \overbrace{\mu_{\cRat} \bar{\cRat}_{t}}^{\bar{\cRat}_{t+1}}(\mu_{\cRat} - 1)\PGro & =(\mu_{\cv} - \PGro) \overbrace{\cv_{t}\mu_{\cv}}^{\cv_{t+1}}
  \end{align*}
  \begin{align*}
  (\mu_{\cRat} - 1)\bar{\cRat}_{t}(\mu_{\cRat} - 1)\PGro & =(\mu_{\cv} - \PGro) \cv_{t}(\mu_{\cv} - 1)
\end{align*}
...
\end{align*}
\begin{align}
%  \mu_{\cRat} - 1 & = \mu_{\cv} - \PGro \\
%  \mu_{\cRat} + \pGro & = \mu_{\cv}  \\
  \mu_{\cv} & = \mu_{\cRat} + (\PGro - 1) \label{eq:aRatGroVscov}
\end{align}
\begin{align*}
